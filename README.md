...
5. Install the mobile [application](https://github.com/Defaultin/BeautyDeep/raw/master/BeautyDeep-v3.0.0-pre-release.apk) or open "BeautyDeep/mobile-app" on your computer and run [main.py](https://github.com/Defaultin/BeautyDeep/blob/master/mobile-app/main.py)
...
2. Install the mobile [application](https://github.com/Defaultin/BeautyDeep/raw/master/BeautyDeep-v3.0.0-pre-release.apk) or open "BeautyDeep/mobile-app" on your computer and run [main.py](https://github.com/Defaultin/BeautyDeep/blob/master/mobile-app/main.py)
