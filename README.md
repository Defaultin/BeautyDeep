...
3. In the server settings of the application, specify the domain (e.g. http://domain.com) or public ip address (e.g. http://192.168.0.102:5000) of your remote server
