...
3. In the server settings of the application, specify the domain (e.g. http://domain.com) or public ip address (e.g. http://34.91.143.244:5000) of your remote server
