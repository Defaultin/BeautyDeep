...
4. Install the mobile [application](https://yadi.sk/d/-EIVnrfo3ryHZA) or open "BeautyDeep/mobile-app" on your computer and run [main.py](https://github.com/Defaultin/BeautyDeep/blob/master/mobile-app/main.py)